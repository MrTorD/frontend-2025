...
if (sId1 && sId2) {
    p = addText(p, sId1, 500, 500, 300, 300, 'Testing Text', 'Times New Roman', 20);
    ...
    p = addImage(p, sId1, 300, 200, 60, 40, 'C:/image.jpg');
    p = addImage(p, sId1, 1500, 300, 200, 150, 'C:/photos/summer.jpg');
    p = addImage(p, sId2, 1000, 1500, 200, 150, 'D:/images/picture.png');
    p = addImage(p, sId2, 0, 0, 400, 600, 'D:/pictures/pict.png');
        ...
        if (obj) {
            switch (obj.type) {
                case 'text':
                    ...
                    p = changeObjPositon(p, objInfo.slideId, objInfo.objId, 200, 300, 400, 500);
                    p = changeFont(p, objInfo.slideId, objInfo.objId, 'Consolas');
                    p = changeTextSize(p, objInfo.slideId, objInfo.objId, 8);
                    break;
                case 'image':
                    p = changeObjPositon(p, objInfo.slideId, objInfo.objId, 200, 300, 50, 0);
